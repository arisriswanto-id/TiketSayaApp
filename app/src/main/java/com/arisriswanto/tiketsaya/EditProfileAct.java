...
public class EditProfileAct extends AppCompatActivity {
    ...
    ImageView pic_photo_edit_profile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(EditProfileAct.this)
                        ...
                        .centerCrop().fit().into(pic_photo_edit_profile);
            }
        ...
        btn_save_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_save_profile.setText("Laoding ...");
    ...
    // dapatkan alamat file, digunakan pada saat menyimpan gambar pada Firebase
    ...
    // function untuk mencari/ ambil photo dari local
